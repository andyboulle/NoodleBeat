...
<!-----------------------------------HTML Code------------------------------------->
        ...
        <p style="color: red; text-align: center; margin-bottom: 5%; margin-top: 5%;">MUST SIGN IN OR CREATE AN ACCOUNT TO LIKE POSTS</p>
        <div class="makeBtns">
            <a href="../../index.php">Return to Home</a><br><br><br>
            <a href="../Register/register.php">Create an Account</a><br><br><br>
            <a href="../Sign-In/sign_in.php">Sign In</a><br><br><br>
        </div>
