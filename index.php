...
<!-----------------------------------HTML Code------------------------------------->
        ...
        <div class="nav-wrapper">
            <div id="navigation">
                ...
                <a href="Page/Browse/browse.php">Browse</a>
                <a href="Page/Contact/contact.php">Contact</a>
                <a href="Page/Profile/profile.php">Profile</a>
                <a href="Page/Upload/upload.php">Upload</a>
                <a href="Page/Register/register.php" style="float: right; border-left: 1px solid black; border-right: none;">Register</a>
                <a href="Page/Sign-In/sign_in.php" style="float: right; border-left: 1px solid black; border-right: none;">Sign In</a>
            </div>  
        </div>
        ...
        <section class="tbl">
            ...
            <table id="tableData" cellpadding="0" cellspacing="0" border="0">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM `tracks` WHERE 1 ORDER BY `date_uploaded` DESC LIMIT 5;";
